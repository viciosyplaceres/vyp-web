...
| `/admin` · `/admin/camisetas` · `/admin/pagos` · `/admin/tareas` · `/admin/compras` · `/admin/deudas` | **Miembros** | Organizar las fiestas lo hace la peña entera, así que la gestión la ve cualquier miembro aprobado: **camisetas** (subir diseños, votar el que más gusta, y cuántas quiere cada uno con su talla), **pagos** (quién está al día con la cuota, sin importes), **tareas** de agosto con calendario, **limpieza** (reparto del 22 al 31 sorteado a dados), **lista de la compra** (con quién la compra) y **deudas** (con foto del ticket). Marcar pagos y apuntar deudas sigue siendo de la directiva |
